...
//
AbstractGrammar.match = function match(source, rule, args, errback) {
  return this.matchAll([source], rule, args, errback);
};
...
// Creates instance of the grammar, invokes rule and returns a result
//
AbstractGrammar.matchAll = function matchAll(source, rule, args, errback) {
